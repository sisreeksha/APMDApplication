...
public class HumiditySensorLimitValues implements SensorLimitValues {
    ...
    private float SATISFACTORY_HIGH_VALUE = 50;
    ...
    private float MODERATE_LOW_VALUE = 51;
    ...
    private float MODERATE_HIGH_VALUE = 70;
    ...
    private float POOR_LOW_VALUE = 71;
    ...
    private float POOR_HIGH_VALUE = 85;
    ...
    private float VERY_POOR_LOW_VALUE = 86;
    ...
    private float VERY_POOR_HIGH_VALUE = 92;
    ...
    private float SEVERE_HIGH_VALUE = 93;
