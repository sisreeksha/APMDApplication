...
public class O3SensorLimitValues implements SensorLimitValues {
    ...
    private float MODERATE_HIGH_VALUE = 168;
    ...
    private float POOR_LOW_VALUE = 169;
    ...
    private float POOR_HIGH_VALUE = 208;
    ...
    private float VERY_POOR_LOW_VALUE = 209;
    ...
    private float VERY_POOR_HIGH_VALUE = 748;
    ...
    private float SEVERE_HIGH_VALUE = 749;
